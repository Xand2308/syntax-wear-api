...
Implementar model Category e relacionamento Product.categoryId
Admin CRUD para categorias e usuários
POST /orders com validação de stock (transacional)
Upload de imagens para Supabase Storage
Endpoint POST /shipping/calc (viaCEP integration)
Testes com Vitest